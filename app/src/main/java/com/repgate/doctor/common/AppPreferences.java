...
public class AppPreferences {
    ...
    public static final String USER_INTERESTS = "doctor_interests";
    ...
    public void saveUserInformation(DoctorProfileResponseData.DataModel responseData) {
        ...
        String area_of_interest = responseData.area_of_interest;
        ...
        mPrefsEditor.putString(USER_INTERESTS, area_of_interest);
    ...
    public String getUserInterests() { return mPrefs.getString(USER_INTERESTS, ""); }
    public void setUserInterests(String interests) {
        mPrefsEditor.putString(USER_INTERESTS, interests);
        mPrefsEditor.commit();
    }
