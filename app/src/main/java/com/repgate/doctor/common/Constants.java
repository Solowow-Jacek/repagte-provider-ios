package com.repgate.doctor.common;
...
public class Constants {
    ...
    public static final String PARAM_USER_COMPANY = "param_user_company";
    ...
    public static final String[] roleArray = new String[]{"UNDEFINED", "ADMINISTRATOR", "PHYSICIAN", "PHYSICIAN ASSISTANT", "NURSE PRACTIONER", "OFFICE MANAGER", "SALES REP"};
    ...
    public static final String PARAM_REQUEST_IS_OFFICER = "param_request_is_officer";
    ...
    public static final String[] statusArray = new String[]{"Initial", "Confirmed", "Changed", "Canceled"};
    public static final String[] actionArray = new String[]{"Initial", "Confirm", "Change", "Cancel"};
    ...
    public static final int RECV_REPS = 2;

    public static ArrayList<ProviderProfileResponseData.DataModel> mOfficersArray;
    public static ArrayList<ProviderProfileResponseData.DataModel> mRepsArray;
