...
public class MainActivity extends Activity implements View.OnClickListener{
    ...
    private Button btnTutorial, btnHealthcareProvider, btnProfile, btnMessageShares, btnRequests;
    ...
    protected void onStart() {
        ...
        if (prefs.getUserRequestNew() != null
                && !prefs.getUserRequestNew().isEmpty()
                && !prefs.getUserRequestNew().equalsIgnoreCase("0"))
    ...
    protected void onResume() {
        ...
        loadReceiverInformation(Constants.RECV_REPS);
        loadReceiverInformation(Constants.RECV_OFFICERS);
    }

    private void loadReceiverInformation(final int recvType) {
        ...
        } else if (recvType == Constants.RECV_REPS) {
            roleNames = String.valueOf(Constants.USER_ROLE_SALES_REP);
        }
                ...
                if (responseData == null) {
                    ...
                    if (responseData.success == true) {
                        ...
                        if (recvType == Constants.RECV_OFFICERS) {
                            ...
                            Constants.mRepsArray = responseData.data;
                        }
    ...
    public void onClick(View view) {
        switch(view.getId()) {
            ...
            case R.id.btnHealthCareProviders:
                Intent intentHealth = new Intent(MainActivity.this, HealthcareProviderActivity.class);
                String userId = prefs.getUserId();
                intentHealth.putExtra(Constants.PARAM_USER_ID, userId);
